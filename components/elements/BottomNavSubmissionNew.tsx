/**
 * Bottom Navbar for new service request form page
 *
 */
        ...
        {props.sectionCompletedIndicators.map((section, index) => {
          return section.completed ? (
            <div
              ...
              className="bg-success w-40 rounded h-5 my-auto shadow-sm"
            ></div>
          ) : (
            <div
              key={section.sectionName}
              className="border-white border w-40 rounded h-5 my-auto"
            ></div>
          );
        })}
      </div>
