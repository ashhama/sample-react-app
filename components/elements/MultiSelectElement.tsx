            ...
            <div className="relative">
              <span className="inline-block w-full rounded-md shadow-sm">
                <Listbox.Button
                  ...
                  name={props.registers.name}
                  className="flex items-center h-11 px-4 w-full border border-site-grey-300 mt-3 rounded-lg focus:outline-none focus:ring-2 overflow-hidden text-site-gray-400"
                >
                  {!selectedItems.length && "One or more selections required"}
